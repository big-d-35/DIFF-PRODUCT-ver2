...
const homePageSmartBlockText = new Vue ({
    ...
    data: {
        ...
        textRU1: 'SMART - это концепция для каждого: для семей и для молодежи, которых объединяет одна цель - насладиться качественным отдыхом за разумные деньги.',
        textRU2: 'В первую очередь, мы предлагаем сервис на звезду выше: анимация, детский клуб, питание и напитки, Wi-Fi, узнаваемый стиль в дизайне и качество по доступной цене.',
        textRU3: 'Кроме того, SMART заботится об окружающей среде, что означает экологически дружелюбную концепцию.  Мы минимизируем использование пластиковых стаканчиков и  отказываемся от трубочек, разумно подходим к трате воды и энергии, устанавливаем мусорные урны для разделения отходов.',
        
        titleBY1: 'Концепция отдыха SMART',
        titleBY2: 'Умный подход к отдыху',
        textBY1: 'SMART - это концепция для каждого: для семей и для молодежи, которых объединяет одна цель - насладиться качественным отдыхом за разумные деньги.',
        ...
        textBY3: 'Кроме того, SMART заботится об окружающей среде, что означает экологически дружелюбную концепцию.  Мы минимизируем использование пластиковых стаканчиков и  отказываемся от трубочек, разумно подходим к трате воды и энергии, устанавливаем мусорные урны для разделения отходов.',
        
        titleUA1: 'Концепция отдыха SMART',
        titleUA2: 'Умный подход к отдыху',
        textUA1: 'SMART - это концепция для каждого: для семей и для молодежи, которых объединяет одна цель - насладиться качественным отдыхом за разумные деньги.',
        textUA2: 'В первую очередь, мы предлагаем сервис на звезду выше: анимация, детский клуб, питание и напитки, Wi-Fi, узнаваемый стиль в дизайне и качество по доступной цене.',
        textUA3: 'Кроме того, SMART заботится об окружающей среде, что означает экологически дружелюбную концепцию.  Мы минимизируем использование пластиковых стаканчиков и  отказываемся от трубочек, разумно подходим к трате воды и энергии, устанавливаем мусорные урны для разделения отходов.',
