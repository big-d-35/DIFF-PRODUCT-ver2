    ...
    data: {
        ...
        country3Hotels : [
            ...
            //HOTEL
            {
                ...
                countryNameRU: 'Кипр, Айя-Напа',
                aboutHotelRUItems: [
                    { item: 'Бассейн, джакузи, солнечная терраса (с бесплатными шезлонгами и зонтиками),' },
                    { item: 'сауна, баня,  массаж, косметические процедуры, спорт-зал (бесплатно)' },
                    { item: 'Для детей:  детский бассейн, игровая площадка, детские стулья и кроватки (бесплатно, по предварительному запросу) и детский клуб Мини Тукан' },
                    { item: 'Отель расположен в 50 м от песчаных пляжей Санди Бич, в 20 минутах ходьбы от центра Айа-Напы' },
