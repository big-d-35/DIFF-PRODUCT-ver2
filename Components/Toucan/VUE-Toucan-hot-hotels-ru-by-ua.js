        ...
        country8Hotels : [
            //HOTEL
            {
                ...
                aboutHotelRUItems: [
                    ...
                    { item: 'Бесплатный трансфер в Дубаи Молл (воскресенье и четверг)' },
                    { item: 'Рядом большой торговый центр (супермаркет)' },
                    { item: 'Двухэтажные корпуса' },
                    { item: 'Караоке, английский паб' },
