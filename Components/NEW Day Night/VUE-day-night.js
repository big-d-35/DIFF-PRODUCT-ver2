    ...
    data: {
        ...
        bannerItems: [
            { 
                ...
                itemEE: 'Новые знакомства и впечатления',
                itemLT: 'Новые знакомства и впечатления',
                itemLV: '',
            },
            
            {
                ...
                itemEE: 'Бурная ночная жизнь',
                itemLT: 'Бурная ночная жизнь',
                itemLV: '',
            ...
            
            {
                ...
                itemEE: 'Активный спортивный день',
                itemLT: 'Активный спортивный день',
                itemLV: '',
            ...
            
            {
                ...
                itemEE: 'Громкая музыка и яркие шоу',
                itemLT: 'Громкая музыка и яркие шоу',
                itemLV: '',
        ...
        aboutTextEE: 'DAY&NIGHT Connected – это время, когда день сменяет ночь, а ты попросту этого не замечаешь. Ведь настоящая жизненная сила – это сила в движении!',
        aboutTextLT: 'DAY&NIGHT Connected – это время, когда день сменяет ночь, а ты попросту этого не замечаешь. Ведь настоящая жизненная сила – это сила в движении!',
        aboutTextLV: 'DAY&NIGHT Connected – это время, когда день сменяет ночь, а ты попросту этого не замечаешь. Ведь настоящая жизненная сила – это сила в движении!',
