const concepts = new Vue({
    ...
    data: {
        ...
        bannerItems: [
            { 
                itemRU: 'Отели с акцентом на активный отдых ',
                itemBY: 'Отели с акцентом на активный отдых ',
                itemUA: 'Отели с акцентом на активный отдых ',
                itemEE: 'Отели с акцентом на активный отдых ',
                itemLT: 'Отели с акцентом на активный отдых ',
                itemLV: '',
            },
            
            {
                itemRU: 'Спортивные развлечения днем',
                itemBY: 'Спортивные развлечения днем',
                itemUA: 'Спортивные развлечения днем',
                itemEE: 'Спортивные развлечения днем',
                itemLT: 'Спортивные развлечения днем',
                itemLV: '',
                
            },
            
            {
                itemRU: 'Шумные вечеринки ночью',
                itemBY: 'Шумные вечеринки ночью',
                itemUA: 'Шумные вечеринки ночью',
        ...
        aboutTitleEE: 'Что такое DAY&NIGHT?',
        aboutTitleLT: 'Что такое DAY&NIGHT?',
        aboutTitleLV: 'Что такое DAY&NIGHT?',
        
        aboutTextRU: 'DAY&NIGHT Connected – формат отдыха, созданный специально для молодых и активных людей. В основе концепции отели 4* и 5* с акцентом для самых динамичных и энергичных, кто любит шумные тусовки и активные развлечения.',
        aboutTextBY: 'DAY&NIGHT Connected – формат отдыха, созданный специально для молодых и активных людей. В основе концепции отели 4* и 5* с акцентом для самых динамичных и энергичных, кто любит шумные тусовки и активные развлечения.',
        aboutTextUA: 'DAY&NIGHT Connected – формат отдыха, созданный специально для молодых и активных людей. В основе концепции отели 4* и 5* с акцентом для самых динамичных и энергичных, кто любит шумные тусовки и активные развлечения.',
        aboutTextEE: 'DAY&NIGHT Connected – формат отдыха, созданный специально для молодых и активных людей. В основе концепции отели 4* и 5* с акцентом для самых динамичных и энергичных, кто любит шумные тусовки и активные развлечения.',
        aboutTextLT: 'DAY&NIGHT Connected – формат отдыха, созданный специально для молодых и активных людей. В основе концепции отели 4* и 5* с акцентом для самых динамичных и энергичных, кто любит шумные тусовки и активные развлечения.',
        aboutTextLV: 'DAY&NIGHT Connected – формат отдыха, созданный специально для молодых и активных людей. В основе концепции отели 4* и 5* с акцентом для самых динамичных и энергичных, кто любит шумные тусовки и активные развлечения.',
        ...
        servicesTitleEE : 'Услуги в отелях DAY&NIGHT Connected',
        servicesTitleLT : 'Услуги в отелях DAY&NIGHT Connected',
        servicesTitleLV : 'Услуги в отелях DAY&NIGHT Connected',
        ...
        servicesItems : [
            ...
            //2
            {
                ...
                items : [
                    ...
                    {
                        itemRU : 'Coffee Shop с зерновым кофе и десертами',
                        itemBY : 'Coffee Shop с зерновым кофе и десертами',
                        itemUA : 'Coffee Shop с зерновым кофе и десертами',
                        itemEE : '',
                        itemLT : '',
                        itemLV : '',
                    },
                    ...
                    {
                        itemRU : 'Широкий выбор блюд на любой вкус',
                        itemBY : 'Широкий выбор блюд на любой вкус',
                        itemUA : 'Широкий выбор блюд на любой вкус',
                        itemEE : '',
                        itemLT : '',
                        itemLV : '',
                    },
